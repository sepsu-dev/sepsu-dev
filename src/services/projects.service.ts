...
let projects: Project[] = [
    {
        ...
        is_public: true,
        skills: [
            { uid: "sk-002", name: "Next.js", icon: "▲" },
            { uid: "sk-003", name: "TypeScript", icon: "💎" },
            { uid: "sk-004", name: "Tailwind CSS", icon: "🎨" },
            { uid: "sk-001", name: "React", icon: "⚛️" },
        ],
    ...
    },
    {
        ...
        skills: [
            { uid: "sk-002", name: "Next.js", icon: "▲" },
            { uid: "sk-003", name: "TypeScript", icon: "💎" },
            { uid: "sk-012", name: "PostgreSQL", icon: "🐘" },
        ],
        created_at: "2025-06-19T08:00:00Z",
        updated_at: "2025-06-19T08:00:00Z",
    },
