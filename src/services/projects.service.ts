...
let projects: Project[] = [
    ...
    },
    {
        ...
        architecture: "React.js → Redux Toolkit → PDF generation (jsPDF). Deployed on Vercel.",
    ...
    },
    {
        ...
        architecture: "Node.js → Express.js → Nodemailer → SMTP. Deployed on Vercel.",
    ...
    },
    {
        ...
        architecture: "Node.js → Express.js → WhatsApp Business API. Deployed on Vercel.",
