...
import { ChevronLeft, Globe, ArrowUpRight, Layout, Layers } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-8 space-y-10">
            <section className="space-y-4">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-foreground flex items-center gap-2 mb-6">
                {project.title}
              </h1>
              ...
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <TechBadge
                    key={tag}
                    tag={tag}
                    className="px-3 py-1.5 text-xs bg-background shadow-sm"
                  />
                ))}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                <a
                  href={project.href}
                  target="_blank"
                  className="flex items-center justify-between p-3.5 rounded-xl bg-primary/90 hover:bg-primary text-primary-foreground text-sm font-medium shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group"
                >
                ...
                {project.githubUrl && (
                  <a
                    ...
                    target="_blank"
                    className="flex items-center justify-between p-3.5 rounded-xl border border-primary/20 bg-transparent hover:bg-muted/50 hover:shadow-md hover:-translate-y-0.5 text-foreground text-sm font-medium transition-all duration-300 group"
                  >
                    <span className="flex items-center gap-2">
