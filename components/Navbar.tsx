    ...
    >
      ...
      >
            ...
            <Link
              ...
              className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 ${
                isActive
                  ...
                  : "text-white/70 hover:text-white hover:bg-white/10 hover:scale-110 hover:-translate-y-0.5 active:scale-95"
              }`}
            >
        ...
        <a
          ...
          aria-label="GitHub"
          title="GitHub"
          className="w-9 h-9 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 hover:scale-110 hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
        >
