      ...
      <div className="max-w-3xl mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            ...
            className="p-1.5 rounded-lg border border-border/50 bg-card/50 hover:bg-muted text-muted-foreground hover:text-foreground transition-all flex items-center justify-center size-8"
