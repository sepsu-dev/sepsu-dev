...
import { Save, Plus, Trash2, FolderPlus, X, Pencil, ChevronLeft, ChevronRight } from "lucide-react";
...
import { saveTechStackAction } from "../actions";
...
export function CategoryClient({ initialCategories, initialItems }: CategoryClientProps) {
  ...
  const removeCategory = async (name: string) => {
    ...
    setSaving(true);
    try {
      const data = await saveTechStackAction(updatedCategories, updatedItems);
